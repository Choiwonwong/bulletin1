...
async def create_post(user_id: str, create_post: CreatePost) -> int:
    return post_service.create_post(create_post)


@post_api_router.put("")
async def modified_post(user_id: str, update_post: UpdatePost) -> int | None:
    return post_service.update_post(update_post)


@post_api_router.delete("/{post_number}")
async def delete_post(post_number: str) -> int | None:
    return post_service.delete_post(post_number)
